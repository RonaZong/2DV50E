...
if __name__ == "__main__":
    image_sample = "../Data/sample_resized1_150/"
    csv_sample = "../Data/sample.csv"

    dataset = DRDataset(
        input_path=image_sample,
        label_path=csv_sample,
        train=True
    ...
    batch_size = 128
    generator_train = DataLoader(dataset, batch_size=batch_size, shuffle=True, num_workers=2)
